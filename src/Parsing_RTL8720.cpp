/**************************************************************************************************************************************
  Parsing_RTL8720-impl.h - Dead simple web-server.
...
int WiFiWebServer::_parseArgumentsPrivate(const String& data,
